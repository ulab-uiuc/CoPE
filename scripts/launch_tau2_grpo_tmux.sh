...
for v in KL_COEF ENTROPY_COEF POLICY_LR ROLLOUT_N TRAIN_BATCH_SIZE PPO_MINI_BATCH_SIZE \
         ...
         ROLLOUT_GPU_MEMORY_UTILIZATION TENSOR_MODEL_PARALLEL_SIZE SAVE_FREQ TRAIN_FILE PLAN_FORECAST_ENABLE PLAN_FORECAST_COEF PLAN_FORECAST_K \
         PLAN_FORECAST_SKIP_INVALID PLAN_FORECAST_GATE \
