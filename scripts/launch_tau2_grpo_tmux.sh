...
for v in KL_COEF ENTROPY_COEF POLICY_LR ROLLOUT_N TRAIN_BATCH_SIZE PPO_MINI_BATCH_SIZE \
         ...
         ROLLOUT_GPU_MEMORY_UTILIZATION TENSOR_MODEL_PARALLEL_SIZE SAVE_FREQ TRAIN_FILE PLAN_FORECAST_ENABLE PLAN_FORECAST_COEF PLAN_FORECAST_K PLAN_FORECAST_K_SCHEDULE \
         PLAN_FORECAST_SKIP_INVALID PLAN_FORECAST_GATE PLAN_FORECAST_GROUP_GATE \
         PLAN_FORECAST_GROUP_LOW_THRESH PLAN_FORECAST_GROUP_HIGH_THRESH PLAN_FORECAST_GROUP_NORM \
         PLAN_FORECAST_GROUP_DEDUP PLAN_FORECAST_SUCCESS_THRESHOLD PLAN_FORECAST_MAX_LENGTH \
         PLAN_FORECAST_TARGET PLAN_FORECAST_SEQ PLAN_FORECAST_COEF_ANNEAL PLAN_FORECAST_COEF_END \
         ...
         PLAN_INLINE_WARMUP_STEPS GRPO_FILTER_DEGENERATE; do
