...
for v in PRESET TRAIN_ENV TAU2_ENV CONDA_SH TAU2_BENCH_DIR TAU2_DATA_DIR MODEL_PATH \
         ...
         ROLLOUT_GPU_MEMORY_UTILIZATION SEND_INTERVAL SAVE_FREQ RESUME_MODE \
         ...
         ACTION_FORECAST_LAYOUT ACTION_FORECAST_BALANCE_CALLS ACTION_FORECAST_TARGETS ACTION_FORECAST_LENGTH_NORM ACTION_FORECAST_SKIP_NO_CALL ACTION_FORECAST_REQUIRE_ACTION \
